    ...
    <!-- end header -->
        ...
        <div class="container">
                ...
                <h5>điểm cũ của bạn: </h5> 
                    ...
                    <span>Thi Olimpic: {{$data->thiolympic}}</span><br>
                    <span>Nghiên cứu khoa học: {{$data->nghiencuukhoahoc}}</span><br>
                    @endforeach
                <hr>
                <form action="{{route('svtao')}}" method="post" enctype="multipart/form-data" class="container" style="margin-top: -60px;">
                    {{csrf_field()}}
