...
<head>
    ...
    <title>Sinh viên xem report</title>
...
<body>
    ...
    <!-- end header -->
    <div class="container">
        <h3>Phản hồi của lớp trưởng và cố vấn</h3>
        <table class="table table-bordered table-hover table-striped dataTable no-footer display" id="myTable">
            <thead>
                <tr>
                    <th>STT</th>
                    <th>Nội dung</th>
  ...
  <div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action = "{{route('svxoa')}}" method="post">
        <div class="modal-body">
