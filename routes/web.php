...
Route::group(['middleware'=>'authen'], function(){
    ...
    Route::group(['prefix'=>'loptruong','middleware'=>'isLoptruong'], function(){
        ...
        Route::post('loptruong/rpcovan','LoptruongController@guirp')->name('guirpcovan');
        Route::post('loptruong/xoa','LoptruongController@xoa')->name('ltxoa');
    });
    Route::group(['prefix'=>'sinhvien','middleware'=>'isSinhvien'], function(){
        ...
        Route::post('sinhvien/xoa','SinhvienController@xoa')->name('svxoa');
    });
    ...
    Route::group(['prefix'=>'covan','middleware'=>'isCovan'], function(){
        ...
        Route::post('covan/xoa','CovanController@xoa')->name('cvxoa');
